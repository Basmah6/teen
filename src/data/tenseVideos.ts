...
export const DEFAULT_TENSE_VIDEOS: Record<string, EducationalVideo[]> = {
  present_simple: [
    {
      ...
      videoUrl: '/videos/present_simple.mp4',
      duration: '04:50',
      channelName: 'ESL Library',
      summaryAr: 'شرح تفصيلي مبسط لزمن المضارع البسيط يتناول مفهوم أزمنة الأفعال، التعبير عن الأفعال المتكررة (Repeated Actions)، صيغتي الفعل (Base verb مقابل verb + s)، وقواعد ضمائر الفاعل وحالات الأسماء المفردة والجمع مع فقرة تمارين تطبيقية.',
      timestamps: [
        { label: 'المقدمة: ما هي أزمنة الأفعال؟ (What are verb tenses?)', timeInSeconds: 0 },
        { label: 'استخدام المضارع البسيط للأفعال المتكررة (Repeated Actions)', timeInSeconds: 18 },
        { label: 'أمثلة الروتين اليومي (Breakfast, Reading, Studying)', timeInSeconds: 28 },
        { label: 'صيغتا الفعل في المضارع البسيط: (Base verb) و (Verb + s)', timeInSeconds: 49 },
        { label: 'ضمائر الفاعل مع الفعل المجرد (I, You, We, They)', timeInSeconds: 76 },
        { label: 'ضمائر المفرد الغائب وإضافة حرف s للفعل (He, She, It)', timeInSeconds: 104 },
        { label: 'حالات أسماء الفاعل: الجمع، المفرد، وغير المعدود', timeInSeconds: 125 },
        { label: 'فقرة التدريب العملي والتطبيق التفاعلي (Practice Session)', timeInSeconds: 175 },
      ]
    }
  ],
  present_continuous: [
    {
      ...
      videoUrl: '/videos/present_continuous.mp4',
      duration: '09:15',
  ...
  present_perfect_continuous: [
    {
      ...
      videoUrl: '/videos/present_perfect_continuous.mp4',
      duration: '11:05',
      channelName: 'درس تعليمي مسجل محلياً',
  ...
  past_simple: [
    {
      ...
      videoUrl: '/videos/past_simple.mp4',
      duration: '10:30',
      channelName: 'درس تعليمي مسجل محلياً',
  ...
  past_continuous: [
    {
      ...
      videoUrl: '/videos/past_continuous.mp4',
      duration: '09:40',
      channelName: 'درس تعليمي مسجل محلياً',
  ...
  past_perfect_continuous: [
    {
      ...
      videoUrl: '/videos/past_perfect_continuous.mp4',
      duration: '08:15',
      channelName: 'درس تعليمي مسجل محلياً',
  ...
  future_simple: [
    {
      ...
      videoUrl: '/videos/future_simple.mp4',
      duration: '11:20',
      channelName: 'درس تعليمي مسجل محلياً',
  ...
  future_continuous: [
    {
      ...
      videoUrl: '/videos/future_continuous.mp4',
      duration: '07:50',
      channelName: 'درس تعليمي مسجل محلياً',
  ...
  future_perfect: [
    {
      id: 'fut_p_vid_1',
      titleAr: 'المستقبل التام (Future Perfect) - اكتمال الأحداث 100% قبل موعد محدد في المستقبل',
      titleEn: 'Future Perfect Tense - Building the Tense & Beating the Deadline',
      videoUrl: '/videos/future_perfect.mp4',
      duration: '05:17',
      channelName: 'The Learning Curve',
      summaryAr: 'شرح شامل لقاعدة المستقبل التام للتعبير عن أحداث ستكون مكتملة بنسبة 100% قبل وقت أو حدث محدد في المستقبل. يتضمن: تشبيه السفر عبر الزمن، المعادلة الثلاثية للزمن (Subject + will have + V3)، قاعدة التغلب على الموعد النهائي (Beating the Deadline) بأمثلة واقعية، واستخدام الكلمة السحرية "By" بمعنى (not later than).',
      timestamps: [
        { label: 'المقدمة: مفهوم اكتمال الحدث بنسبة 100% وتشبيه السفر عبر الزمن', timeInSeconds: 0 },
        { label: 'القسم الثاني: المعادلة الثلاثية للزمن (Subject + will have + V3)', timeInSeconds: 53 },
        { label: 'أمثلة المعادلة وتناسق will have مع جميع الضمائر', timeInSeconds: 95 },
        { label: 'القسم الثالث: التغلب على الموعد النهائي (Beating the Deadline)', timeInSeconds: 116 },
        { label: 'أمثلة واقعية من الحياة اليومية (Homework & Hospital)', timeInSeconds: 156 },
        { label: 'القسم الرابع: الكلمة السحرية By وسلاح الزمن السري (Not later than)', timeInSeconds: 207 },
        { label: 'التطبيق والتحدي الذاتي: Will you have graduated by 2026?', timeInSeconds: 271 },
      ]
    }
  ],
